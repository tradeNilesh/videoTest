...
(function(n, t) {
    ...
    n.Socket = r, t.util.mixin(r, t.EventEmitter), r.prototype.of = function(n) {
        return this.namespaces[n] || (this.namespaces[n] = new t.SocketNamespace(this, n), n !== "" && this.namespaces[n].packet({
            type: "connect"
        })), this.namespaces[n]
        ...
        function s(t) {
            if (t instanceof Error) o.onError(t.message);
            else n.apply(null, t.split(":"))
        }
        var o = this,
            f = this.options,
        ...
        for (var u = n || this.transports, f, i, r = 0; i = u[r]; r++)
            if (t.Transport[i] && t.Transport[i].check(this) && (!this.isXDomain() || t.Transport[i].xdomainCheck())) return new t.Transport[i](this, this.sessionid);
        return null
        ...
        function i() {
            if (n.connected) {
                for (var i in n.namespaces) n.namespaces.hasOwnProperty(i) && "" !== i && n.namespaces[i].packet({
                    type: "connect"
                });
        ...
        function t() {
            ...
            if (n.reconnectionAttempts++ < u) n.reconnectionDelay < f && (n.reconnectionDelay *= 2), n.connect(), n.publish("reconnecting", n.reconnectionDelay, n.reconnectionAttempts), n.reconnectionTimer = setTimeout(t, n.reconnectionDelay);
            else if (n.redoTransports) n.publish("reconnect_failed"), i();
            else {
        ...
        var n = this,
            u = this.options["max reconnection attempts"],
    ...
    n.SocketNamespace = i, t.util.mixin(i, t.EventEmitter), i.prototype.$emit = t.EventEmitter.prototype.emit, i.prototype.of = function() {
        ...
        switch (n.type) {
            case "connect":
                ...
                break;
            case "disconnect":
                if (this.name === "") this.socket.onDisconnect(n.reason || "booted");
                else this.$emit("disconnect", n.reason);
                break;
            case "message":
            case "json":
            ...
            case "ack":
                ...
                break;
            case "error":
                if (n.advice) this.socket.onError(n);
                else n.reason == "unauthorized" ? this.$emit("connect_failed", n.reason) : this.$emit("error", n.reason)
        }
    ...
    n.websocket = r, t.util.inherit(r, t.Transport), r.prototype.name = "websocket", r.prototype.open = function() {
        var u = t.util.query(this.socket.options.query),
            n = this,
            r;
...
if ("undefined" != typeof window) var swfobject = function() {
    ...
    function pt(n) {
        ...
        else if (typeof r.attachEvent != i) dt(r, "onload", n);
        ...
        if (y > 0)
            for (r = 0; r < y; r++) {
                ...
                if (n.pv[0] > 0) {
                    t = u(o);
                    if (t)
                        if (!g(h[r].swfVersion) || n.wk && n.wk < 312)
                            if (h[r].expressInstall && tt()) {
                    ...
                    else l(o, !0), s && (f.success = !0, f.ref = it(o), s(f))
    ...
    function ft(t) {
        var e = s("div"),
            u, i, o, r;
        if (n.win && n.ie) e.innerHTML = t.innerHTML;
        else {
            u = t.getElementsByTagName(f)[0];
            if (u) {
                i = u.childNodes;
                if (i)
                    for (o = i.length, r = 0; r < o; r++) i[r].nodeType == 1 && i[r].nodeName == "PARAM" || i[r].nodeType == 8 || e.appendChild(i[r].cloneNode(!0))
            }
        }
        return e
    }
    ...
    var i = "undefined",
        f = "object",
        at = "Shockwave Flash",
        ti = "ShockwaveFlash.ShockwaveFlash",
        p = "application/x-shockwave-flash",
        lt = "SWFObjectExprInst",
        yt = "onreadystatechange",
        r = window,
        t = document,
        o = navigator,
        vt = !1,
        ...
        n = function() {
            var a = typeof t.getElementById != i && typeof t.getElementsByTagName != i && typeof t.createElement != i,
                ...
                e = o.platform.toLowerCase(),
                l = e ? /win/.test(e) : /win/.test(s),
                y = e ? /mac/.test(e) : /mac/.test(s),
                v = /webkit/.test(s) ? parseFloat(s.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1,
                h = !1,
                u = [0, 0, 0],
                n = null,
                c;
            if (typeof o.plugins != i && typeof o.plugins[at] == f) n = o.plugins[at].description, !n || typeof o.mimeTypes != i && o.mimeTypes[p] && !o.mimeTypes[p].enabledPlugin || (vt = !0, h = !1, n = n.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), u[0] = parseInt(n.replace(/^(.*)\..*$/, "$1"), 10), u[1] = parseInt(n.replace(/^.*\.(.*)\s.*$/, "$1"), 10), u[2] = /[a-zA-Z]/.test(n) ? parseInt(n.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0);
    ...
    return {
        ...
        embedSWF: function(t, r, u, e, o, s, h, c, a, v) {
            ...
            n.w3 && !(n.wk && n.wk < 312) && t && r && u && e && o ? (l(r, !1), kt(function() {
                ...
                if (g(o)) d = rt(n, p, r), n.id == r && l(r, !0), y.success = !0, y.ref = d;
                else {
                    if (s && tt()) {
                        n.data = s, et(n, p, r, v);
                        return
        ...
        getQueryParamValue: function(n) {
            ...
            if (r) {
                ...
                for (u = r.split("&"), i = 0; i < u.length; i++)
                    if (u[i].substring(0, u[i].indexOf("=")) == n) return st(u[i].substring(u[i].indexOf("=") + 1))
            }
            return ""
        },
...
(function() {
    ...
    location.protocol == "file:" && n.error("WARNING: web-socket-js doesn't work in file:///... URL unless you set Flash Security Settings properly. Open the page via Web server i.e. http://..."), WebSocket = function(n, t, i, r, u) {
        ...
        for (u = this.__events[n], r = u.length - 1; r >= 0; --r)
            if (u[r] === t) {
                u.splice(r, 1);
                break
            }
        ...
        if (n.type == "open" || n.type == "error") t = this.__createSimpleEvent(n.type);
        else if (n.type == "close") t = this.__createSimpleEvent("close");
        else if (n.type == "message") i = decodeURIComponent(n.message), t = this.__createMessageEvent("message", i);
        else throw "unknown event type: " + n.type;
    ...
    n.XHR = r, t.util.inherit(r, t.Transport), r.prototype.open = function() {
        ...
        var i = t.util.request(this.socket.isXDomain()),
    ...
    n["jsonp-polling"] = r, t.util.inherit(r, t.Transport["xhr-polling"]), r.prototype.name = "jsonp-polling", r.prototype.post = function(n) {
        ...
        var r = this,
            h = t.util.query(this.socket.options.query, "t=" + +new Date + "&i=" + this.index);
        if (!this.form) {
        ...
        var r = this,
            ...
            f = t.util.query(this.socket.options.query, "t=" + +new Date + "&i=" + this.index),
            i;
